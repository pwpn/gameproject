...
public class Tatakai extends JFrame{
    ...
    Boss1 boss1=new Boss1("",650,150,new JFrame());static int bossi=0;static int ysi=0; 
    static int boo=0;
...
//                gameresult(); 
    ...
    public void bossattack(){
        switch(boss1.randomm()){
            case 1:boo1=1;
                double shang=boss1.skill1(boss1.b1nowattack,ys.yourdefence);boo3=1;
            ...
            case 2:
                ...
                break;
            case 3:
                double shan=boss1.skill3(boss1.b1nowattack,ys.yourdefence);boo3=1;
