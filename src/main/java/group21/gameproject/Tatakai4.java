 ...
 * @author Lenovo
 */
public class Tatakai4 extends JFrame{
    ...
    Boss4 boss4=new Boss4("",630,120,new JFrame());static int bossi=0; static int ysi=0;
    ...
    public static void main(String[] args){
            new Tatakai4(new Theman("",0,0,new JFrame()));
    }
//    
    
    public Tatakai4(Theman tm){
...
//        this.setDefaultCloseOperation(2);
        ...
        new Timer(200, new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(bossi<=3){
                    Image bossimg=boss4.imgg[bossi++];
                    boss4.img=bossimg;
                    if(bossi==3){
                        bossi=0;
                    }
    ...
    private void attackbt(){
        superjb.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                double shang=ys.chaobisha(ys.yourattack,boss4.b1nowdefence);
                if((boss4.b1nowblood-shang)>=0){
                    boss4.b1nowblood-=shang;
                }else{
                    boss4.b1nowblood=0;
                }
                if(boss4.bldeflev>-6){
        ...
        jbb2.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                double shang=ys.jineng2(ys.yourattack,boss4.b1nowdefence);
                if((boss4.b1nowblood-shang)>=0){
                    boss4.b1nowblood-=shang;
                }else{
                    boss4.b1nowblood=0;
               ...
               boss4.b1nowdefence=boss4.b1defence+((boss4.b1defence/10)*boss4.bldeflev);
               System.out.println(boss4.b1nowdefence);
        ...
        jbb3.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(ys.yourspeed>=boss4.b1speed){
                    
                    double shang=ys.jineng3(ys.yourattack,boss4.b1nowdefence);
                   if((boss4.b1nowblood-shang)>=0){
                       boss4.b1nowblood-=shang;
                   }else{
                       boss4.b1nowblood=0;
    ...
    public void bossattack(){
        switch(boss4.randomm()){
            case 1:boo1=1;
                ...
                break;
            case 2:boo1=1;boo3=1;
                double shang=boss4.skill2(boss4.b1nowattack,ys.yourdefence);
                ...
                break;
            case 3:boo3=1;
                double shan=boss4.skill3(boss4.b1nowattack,ys.yourdefence);
            ...
            case 4:boo1=1;boo3=1;
                double sha=boss4.skill4(boss4.b1nowattack,ys.yourdefence);
               if((ys.yourblood-sha)>=0){
                    ys.yourblood-=sha;
                }else{
                    ys.yourblood=0;
                }
               
               if(ys.yourblood<=(ys.getblood()/5)){
                    ys.yourblood=0;                   
               }
                bossi=4;
                break;
...
//            }
                ...
                gImage.drawString("攻击：",900,70);gImage.drawString(Integer.toString((int)(boss4.blattlev)), 940, 70);
                gImage.drawString("防御：",900,90);gImage.drawString(Integer.toString((int)(boss4.bldeflev)), 940, 90);                
                ...
                gImage.drawString(Integer.toString((int)(boss4.b1nowblood)), 755, 70);
                ...
                double chuboss=boss4.b1nowblood/boss4.b1blood;
...
//                boss1.paintSelft(gImage);
    ...
    public void setisdead(){
        if(ys.yourblood<=0||boss4.b1nowblood<=0){
            isdead=true;
        }
    } 
    ...
    public void gameresult(){
        ...
        if(boss4.b1nowblood<=0&&isdead){       fsbg.stop();
            System.out.println("win");
                try {
                    Thread.sleep(500);this.dispose(); new Victory(); 
                } catch (InterruptedException ex) {
                    Logger.getLogger(Tatakai.class.getName()).log(Level.SEVERE, null, ex);
                }     
            ys.returnyou();
